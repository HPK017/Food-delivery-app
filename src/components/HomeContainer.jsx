        ...
        <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full' id='home'>
            <div className='py-2 flex-1 flex flex-col items-start  justify-center gap-6'>
                ...
                <p className='text-base text-textColor text-center md:text-left md:w-[80%]'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores cupiditate fugit vitae impedit, illum repudiandae magnam laborum dicta, porro error cumque! Nisi possimus dolor dolores harum saepe culpa, dolorem illo.
                </p>
            ...
            <div className='py-2 flex-1 flex items-center relative'>
                ...
                <div
                    className='w-full h-full absolute top-0 left-0 flex items-center justify-center lg:px-20  py-4 gap-4 flex-wrap'>
